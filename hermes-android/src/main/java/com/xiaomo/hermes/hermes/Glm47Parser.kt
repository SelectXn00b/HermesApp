...
class Glm47ToolCallParser : Glm45ToolCallParser() {
    ...
    companion object {
        private const val _TAG = "Glm47Parser"
    ...
    override fun parse(response: String): ParseResult {
        ...
        return try {
            ...
            val toolCalls = mutableListOf<com.xiaomo.hermes.hermes.ParsedToolCall>()
            while (funcMatcher.find()) {
                ...
                toolCalls.add(com.xiaomo.hermes.hermes.ParsedToolCall(
