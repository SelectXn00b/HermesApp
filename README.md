...
<div align="center">
  <img src="app/src/main/res/playstore-icon.png" width="120" height="120" alt="墨思 Logo">
  <h1>墨思 - 智能助手应用</h1>
...
<div align="center">
  <div style="padding: 10px 0; text-align: center;">
    <img src="docs/assets/9f85b39450c8616909039b66d15a475a.jpg" width="22%" alt="墨思预览图1" style="display: inline-block; border-radius: 8px; box-shadow: 0 5px 15px rgba(0,0,0,0.15); margin: 0 3px; max-width: 220px;">
    <img src="docs/assets/88a7b7520e4628682a849cc00716c8de.jpg" width="22%" alt="墨思预览图2" style="display: inline-block; border-radius: 8px; box-shadow: 0 5px 15px rgba(0,0,0,0.15); margin: 0 3px; max-width: 220px;">
    <img src="docs/assets/9036f349c25888d357de5ce34580176d.jpg" width="22%" alt="墨思预览图3" style="display: inline-block; border-radius: 8px; box-shadow: 0 5px 15px rgba(0,0,0,0.15); margin: 0 3px; max-width: 220px;">
    <img src="docs/assets/d12038f26df3f814b4e3ce967537f039.jpg" width="22%" alt="墨思预览图4" style="display: inline-block; border-radius: 8px; box-shadow: 0 5px 15px rgba(0,0,0,0.15); margin: 0 3px; max-width: 220px;">
  </div>
</div>
...
**墨思** 是移动端首个功能完备的 AI 智能助手应用，完全独立运行于您的 Android 设备上（除API调用），拥有强大的**工具调用能力**、**深度搜索**、**工作流与自动化**、**智能记忆库**，并支持**人设定制**与**角色卡**等高度自定义功能，集成 **MNN/llama.cpp 本地模型**、**MCP/Skill 生态**与**多语言界面**。它不仅仅是聊天界面，更是与Android权限和各种工具深度融合的**全能助手**，内置**Ubuntu 24 环境**，提供前所未有的强大功能。
...
• <b>插件、工作区与上下文增强</b>：支持通过配置编辑器调试和自动编写 墨思 插件，新增本地 HTTP 对话入口、工作区重命名与规则文件自动读取，并增强历史跳转、双向分页与上下文自动补充能力<br>
...
欢迎加入 墨思 开源生态！我们欢迎各种贡献：第三方脚本、MCP插件、核心功能开发。
...
<div align="center">
  ...
  <p><b>🚀 帮助我们推广，让更多人了解 墨思 🚀</b></p>
  
  <br>
  
  <sub>Made with ❤️ by the 墨思 Team</sub>
</div>
